    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emirates', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.emirate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.CharField(max_length=255)),
                ('profile_picture', models.ImageField(blank=True, upload_to='uploads/customer_profile_pics/')),
                ('phone_number', models.CharField(max_length=15)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='home.customuser')),
            ],
        ),
